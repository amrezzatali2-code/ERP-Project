...
namespace ERP.Migrations
{
    ...
    [Migration("20260429171426_20260429113000_AddSalesInvoicePrintTracking")]
    partial class _20260429113000_AddSalesInvoicePrintTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Models.Customer", b =>
                {
                    ...
                    b.Property<string>("TaxIdOrNationalId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("ERP.Models.PrintHeaderSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PrintHeaderSettings", (string)null);
                });
            ...
            modelBuilder.Entity("ERP.Models.ProductClassification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Models.ProductDiscountOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("OverrideDiscountPct")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.HasIndex("ProductId")
                        .HasDatabaseName("IX_ProductDiscountOverrides_Product");

                    b.HasIndex("WarehouseId");

                    b.HasIndex("ProductId", "WarehouseId", "BatchId")
                        .HasDatabaseName("IX_ProductDiscountOverrides_ProductWarehouseBatch");

                    b.ToTable("ProductDiscountOverrides", (string)null);
                });
            ...
            modelBuilder.Entity("ERP.Models.PurchasePolicyRule", b =>
                {
                    ...
                    b.Property<byte>("CompareOp")
                        .HasColumnType("tinyint");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<decimal?>("DiffExact")
                    ...
                    b.Property<decimal?>("StockBelowPercent")
                        .HasColumnType("decimal(9,2)");
            ...
            modelBuilder.Entity("ERP.Models.PurchasingDataSourceConfig", b =>
                {
                    ...
                    b.ToTable("PurchasingDataSourceConfigs");
                });
            ...
            modelBuilder.Entity("ERP.Models.PurchasingOrder", b =>
                {
                    ...
                    b.Property<int?>("ErpPurchaseRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ErpPurchaseRequestId");

                    b.ToTable("PurchasingOrders");
                });

            modelBuilder.Entity("ERP.Models.PurchasingOrderAmendment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PurchasingOrderAmendments");
                });

            modelBuilder.Entity("ERP.Models.PurchasingOrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PurchasingOrderLines");
                });
            ...
            modelBuilder.Entity("ERP.Models.RoleAccountVisibilityOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RoleAccountVisibilityOverrides", (string)null);
                });
            ...
            modelBuilder.Entity("ERP.Models.SalesInvoice", b =>
                {
                    ...
                    b.Property<decimal>("CustomerBalanceAtSave")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ERP.Models.SalesInvoiceRoute", b =>
                {
                    ...
                    b.Property<int?>("ControlEmployeeId")
                        .HasColumnType("int");

                    b.Property<int?>("DistributorEmployeeId")
                        .HasColumnType("int");

                    b.Property<int>("FridgeBoxesCount")
                        .HasColumnType("int");

                    b.Property<int>("FridgeItemsCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PreparerEmployeeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ControlEmployeeId");

                    b.HasIndex("DistributorEmployeeId");

                    b.HasIndex("PreparerEmployeeId");

                    b.ToTable("SalesInvoiceRoutes", (string)null);
                });

            modelBuilder.Entity("ERP.Models.SalesInvoiceRouteFridgeLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SalesInvoiceRouteFridgeLines", (string)null);
                });
            ...
            modelBuilder.Entity("ERP.Models.StockAdjustmentLine", b =>
                {
                    ...
                    b.Property<decimal?>("WeightedDiscountPct")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("ERP.Models.UserAccountVisibilityOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserAccountVisibilityOverrides", (string)null);
                });
            ...
            modelBuilder.Entity("ERP.Models.VendorFaxLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ProductNameFromVendor")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<int>("VendorFaxUploadId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VendorFaxUploadId");

                    b.ToTable("VendorFaxLines");
                });

            modelBuilder.Entity("ERP.Models.VendorFaxUpload", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VendorFaxUploads");
                });

            modelBuilder.Entity("ERP.Models.VendorProductMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomerId", "VendorProductCode");

                    b.HasIndex("CustomerId", "VendorProductName");

                    b.ToTable("VendorProductMappings");
                });
            ...
            modelBuilder.Entity("ERP.Models.Product", b =>
                {
                    ...
                    b.HasOne("ERP.Models.ProductClassification", "Classification")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ERP.Models.PurchasingOrder", b =>
                {
                    ...
                    b.HasOne("ERP.Models.PurchaseRequest", "ErpPurchaseRequest")
                        .WithMany()
                        .HasForeignKey("ErpPurchaseRequestId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Customer");

                    b.Navigation("ErpPurchaseRequest");
                });

            modelBuilder.Entity("ERP.Models.PurchasingOrderAmendment", b =>
                {
                    b.HasOne("ERP.Models.PurchasingOrder", "PurchasingOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP.Models.SalesInvoiceRoute", b =>
                {
                    b.HasOne("ERP.Models.Employee", "ControlEmployee")
                        .WithMany()
                        .HasForeignKey("ControlEmployeeId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ERP.Models.Employee", "DistributorEmployee")
                        .WithMany()
                        .HasForeignKey("DistributorEmployeeId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ERP.Models.Employee", "PreparerEmployee")
                        .WithMany()
                        .HasForeignKey("PreparerEmployeeId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ERP.Models.SalesInvoice", "SalesInvoice")
                        .WithOne("Route")
                        .HasForeignKey("ERP.Models.SalesInvoiceRoute", "SIId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ControlEmployee");

                    b.Navigation("DistributorEmployee");

                    b.Navigation("PreparerEmployee");
            ...
            modelBuilder.Entity("ERP.Models.SalesInvoiceRouteFridgeLine", b =>
                {
                    ...
                    b.HasOne("ERP.Models.SalesInvoiceRoute", "Route")
                        .WithMany("FridgeLines")
                        .HasForeignKey("SIId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Models.VendorFaxLine", b =>
                {
                    b.HasOne("ERP.Models.Product", "MatchedProduct")
                        .WithMany()
                        .HasForeignKey("MatchedProductId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ERP.Models.VendorFaxUpload", "VendorFaxUpload")
                        .WithMany("Lines")
                        .HasForeignKey("VendorFaxUploadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MatchedProduct");

                    b.Navigation("VendorFaxUpload");
                });
