...
الملف المرجعي للتصدير: `docs/ERP_Documentation_Full.md` (محتوى موازٍ تقريباً لـ `README.md` في جذر المشروع). عند تحديث التعريفات العامة، يُفضّل تعديل `README.md` أولاً ثم مواءمة الملف المجمّع قبل التصدير.

يمكنك التحويل إلى Word بعدة طرق:
