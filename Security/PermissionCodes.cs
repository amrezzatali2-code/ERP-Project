...
namespace ERP.Security
{
    ...
    public static class PermissionCodes
    {
        ...
        private static readonly (string Controller, string[] Actions, string Module)[] Definitions =
        {
            ...
            ("Reports", new[] { "ProductBalances", "BonusReport", "CustomerBalances", "ExportCustomerBalances", "ExportProductBalances", "ProductProfits", "CustomerProfits", "SalesPerformanceReport", "PurchasePerformanceReport", "FixOrphanedPaymentEntries", "ZeroCustomerBalance", "SyncStockBatchesFromLedger", "ZeroPhantomSalesReturnRemaining", "CleanOrphanedStockLedger", "ZeroProductBalance", "SaveManualDiscount" }, "التقارير"),
